...
const BusinessPricingPage = lazy(() => import('./pages/BusinessPricingPage'));
const TVHomePage        = lazy(() => import('./tv/TVHomePage'));
            ...
            <main className="pt-14 pb-24 lg:pb-6 min-h-screen">
              <Suspense fallback={<FullPageLoader />}>
                ...
                <Routes>
                  ...
                  <Route path="/coreografias"        element={<ChoreographyPage />} />
                  ...
                  <Route path="/precios"             element={<BusinessPricingPage />} />
