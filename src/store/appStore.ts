...
export type UserRole = 'user' | 'artist' | 'dj' | 'dancer' | 'venue' | 'admin' | 'superadmin' | 'instructor' | 'business' | 'promoter' | 'partner' | 'band' | 'musician' | 'animador';
...
export const DEFAULT_HOME_CATEGORIES: HomeCategory[] = [
  ...
  { id: '2',  name: 'Ciudades',        icon: '🏙️', route: '/venues',                    section: 'main',      display_order: 2,  active: true },
  ...
  { id: '6',  name: 'Marketplace',     icon: '🛍️', route: '/marketplace',               section: 'main',      display_order: 6,  active: true },
