...
export const FIELDS_ARTIST: EditField[] = [
  ...
  { key: 'type', label: 'Categoría principal', type: 'select', options: [
      ...
      { value: 'animador', label: 'Animador/a de eventos' },
  ...
  { key: 'featured_video', label: 'Vídeo destacado (YouTube URL)', type: 'text', cols: 2, placeholder: 'https://www.youtube.com/watch?v=…' },
  { key: 'featured_video_title', label: 'Título del vídeo', type: 'text', cols: 2 },
